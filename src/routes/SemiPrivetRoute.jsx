...
const SemiPrivetRoute = ({ children }) => {
    ...
    return <div className='flex flex-col justify-center items-center text-center min-h-[60vh]'>
        ...
        <div>
            <h3 className='text-2xl sm:text-3xl md:text-4xl font-semibold'>You are not signed in!</h3>
            <h3 className='text-2xl sm:text-3xl md:text-4xl font-semibold'>Please sign in to continue</h3>
        </div>
        <Link to="/sign-in">
